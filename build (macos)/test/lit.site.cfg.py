# Autogenerated from /Users/maxwellkapral/llvm-project/llvm/test/lit.site.cfg.py.in
# Do not edit!
...
config.host_ldflags = '-L/usr/local/opt/bison/lib'
...
config.llvm_host_triple = 'x86_64-apple-darwin19.6.0'
